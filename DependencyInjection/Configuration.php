                ...
                ->arrayNode('form')->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('attendee')->isRequired()->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type')->defaultValue('rizza_calendar.attendee')->end()
                                ->scalarNode('name')->defaultValue('rizza_calendar_attendee')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                    ...
                    ->children()
                        ...
                        ->arrayNode('event')->isRequired()->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('delete')->defaultValue('rizza_calendar_event_delete')->end()
                            ->end()
                        ->end()
                        ->arrayNode('attendee')->isRequired()->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('list')->defaultValue('rizza_calendar_attendee_list')->end()
                                ->scalarNode('add')->defaultValue('rizza_calendar_attendee_add')->end()
                                ->scalarNode('show')->defaultValue('rizza_calendar_attendee_show')->end()
                                ->scalarNode('edit')->defaultValue('rizza_calendar_attendee_edit')->end()
                                ->scalarNode('delete')->defaultValue('rizza_calendar_attendee_delete')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                    ...
                    ->children()
                        ->arrayNode('blamer')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('attendee')->cannotBeEmpty()->defaultValue('rizza_calendar.blamer.attendee.security')->end()
                            ->end()
                        ->end()
                        ->arrayNode('creator')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('calendar')->cannotBeEmpty()->defaultValue('rizza_calendar.creator.calendar.default')->end()
                                ->scalarNode('event')->cannotBeEmpty()->defaultValue('rizza_calendar.creator.event.default')->end()
                                ->scalarNode('attendee')->cannotBeEmpty()->defaultValue('rizza_calendar.creator.attendee.default')->end()
                            ->end()
                        ->end()
                        ->arrayNode('form_factory')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('attendee')->cannotBeEmpty()->defaultValue('rizza_calendar.form_factory.attendee.default')->end()
                            ->end()
                        ->end()
                        ->arrayNode('manager')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('attendee')->cannotBeEmpty()->defaultValue('rizza_calendar.manager.attendee.default')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
